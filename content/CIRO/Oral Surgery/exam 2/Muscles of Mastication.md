...
## Temporalis ms.
function: **elevation** (anterior part) and **retrusion** (middle and posterior parts of the temporalis)
- since the temporalis is fan shaped, the function depends on which part of the temporalis contracts, whereas the anterior fibers are more verticle and the middle and posterior parts run obliquely in an anterior direction (thus when contracted retrudes the mandible)
...
- unilateral contraction - mediotrusion on the same side of contraction/laterotrusion on the opposite side
action (superior lateral pterygoid)
- active in conjunction with elevator muscles when closing against a force (chewing through a hard candy)
...
- posterior belly
	...
	- insertion: intermediate tendon, which is attached to the hyoid bone
- anterior belly
	- origin: lingual surface of mandible
	- insertion: intermediate tendon (same as posterior belly) that attaches to the hyoid bone
